        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="12" :lg="8">
            <el-form-item label="美德" prop="virtue_id">
              ...
              <el-input class="virtue_input" :disabled="true" v-model="ruleForm.virtue_name" style="width: 65%;"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
 ...
 'name': {
    get () {
      return this.$store.state.fx1.form.user
    },
    set (value) {
      this.$store.commit('fx1_name', value)
      // 添加如下：
      this.ruleForm.user = value

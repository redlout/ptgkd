            ...
            <el-col :xs="12" :sm="12" :lg="24">
              ...
              <el-form-item label="速度" prop="name">
                <span @change="handlechange()"> :力量【{{$store.state.fx2.tableData[0].base}}】+ 
                    ...
                    敏捷附加【{{$store.state.fx2.tableData[1].additional}}】*5 = {{this.derivative.speed}}</span>
...
export default {
  ...
  methods:{
          //响应变化
    handleEdit(){
        // this.derivative.speed = this.attributeData.tableData[0].base+
        // this.attributeData.tableData[1].base+ 
        // this.baseData.form.volume+
        // this.attributeData.tableData[1].additional*5;
    },
  }
};
</script>

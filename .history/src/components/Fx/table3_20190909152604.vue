      ...
      <el-col :xs="12" :sm="12" :lg="24">
        ...
        >
          ...
          <el-table-column prop="professional" label="专业" align="center">
            <template slot-scope="scope">
              <el-select v-model="scope.row.professional" 
              multiple filterable allow-create 
              placeholder="请选择专业">
              <el-option v-for="item in tableData.options"
               :key="item.value" 
               :label="item.label" 
               :value="item.value">
              </el-option>
              </el-select>
              <!-- <el-input style="width:80%" size="small" v-model="scope.row.professional"></el-input> -->

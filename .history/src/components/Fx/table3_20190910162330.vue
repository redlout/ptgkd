        ...
        >
          ...
          <el-table-column prop="sel" label="专业" align="center">
            <template slot-scope="scope">
              ...
              <el-input style="width:50%" size="small" v-model="professional_table.sel"></el-input>
              <el-button
                type="primary"
                plain
    ...
    <el-dialog :visible.sync="Dialog" center >
      ...
      <el-row>
        <el-col :span="24">
          ...
          <el-table-column 
          :prop="professional_table.columns[0].field" 
          :label="professional_table.columns[0].title"
          :width="professional_table.columns[0].width"
          :key="professional_table.columns[0].id">
            <template slot-scope="scope">
                <span v-if="scope.row.isSet">
                  <el-autocomplete
                  class="inline-input"
                    ...
                    :fetch-suggestions="querySearch"
                    @select="handleSelect"
                    v-model="tableData.sel[professional_table.columns[0].field]"
                  ></el-autocomplete>
                </span>
                <span v-else>{{scope.row[professional_table.columns[0].field]}}</span>
              </template>
          </el-table-column>
        ...
        <span>{{this.professional_table}}</span>
      </el-row>
    </el-dialog>
  </div>
</template>

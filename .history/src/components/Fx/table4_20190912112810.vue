            ...
            <el-col :xs="12" :sm="12" :lg="24">
              ...
              <!-- <el-form-item label="速度" prop="name">
                <span @change="handlechange()"> :力量【{{$store.state.fx2.tableData[0].base}}】+ 
                    ...
                    敏捷附加【{{$store.state.fx2.tableData[1].additional}}】*5 = {{$store.state.fx4.speed}}</span>
              </el-form-item> -->
                <el-form-item label="速度" prop="name">
                <span @change="handlechange()"> :力量【{{power}}】+ 
                    敏捷【{{agile}}】+
                    体积【{{volume}}】+
                    敏捷附加【{{agileAdditional}}】*5 = {{speed}}</span>
              </el-form-item>
            </el-col>
...
export default {
  ...
  computed:{
      ...mapState({
          power: state => $store.state.fx2.tableData[0].base,
          agile: state => $store.state.fx2.tableData[1].base,
          volume: state => $store.state.fx1.form.volume,
          agileAdditional: state => $store.state.fx2.tableData[1].additional,
          speed: state => $store.state.fx4.speed
      })
  }
};
</script>

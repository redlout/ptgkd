  ...
  <div style="width:90%; margin:0 auto">
    <el-row>
      <el-col :xs="12" :sm="12" :lg="24">
        ...
        >
          <el-table-column prop="species" width="5%" align="center"></el-table-column>
          <el-table-column prop="name" label="属性名" width="5%" align="center"></el-table-column>
          <el-table-column prop="base" label="基础" align="center" width="30%">
          ...
          <el-table-column prop="inner" label="内在" align="center" width="30%">
            <template slot-scope="scope">
              <el-input-number
                size="small"
                :min="0"
          ...
          <el-table-column prop="total" label="总计" align="center" width="15%">
            <template slot-scope="scope">
              <el-input
                style="width:80%"
                size="small"
          ...
          <el-table-column prop="additional" label="附加成功" align="center" width="15%">
            <template slot-scope="scope">
              <el-input
                size="small"
                style="width:80%"

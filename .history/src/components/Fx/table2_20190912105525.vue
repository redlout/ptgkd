...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row){
        ...
        //速度
        this.$store.state.fx4.speed = this.tableData[0].base+
        this.tableData[1].base+ 
        this.$store.state.fx1.form.volume+
        this.tableData[1].additional*5;
        //先攻 （敏捷【】+沉着【】+沉着附加【 】×4）= 18
        this.$store.state.fx4.strike = this.tableData[1].base + 
        this.tableData[1].base + 
        this.tableData[1].additional*4;
        //防御 （敏捷与感知中较低者【1】）=  1 +较高者的附加成功【1】
        if(this.tableData[1].base > this.tableData[4].base){
          this.$store.state.fx4.defense = this.tableData[4].base + 
          this.tableData[1].additional;
        }else{
          this.$store.state.fx4.defense = this.tableData[1].base + 
          this.tableData[4].additional;
        }
        // 生命值 （耐力【1】+体积【5】+耐力附加【 】×2）=6
        this.$store.state.fx4.life = this.tableData[2].base + 
        this.$store.state.fx1.form.volume+
        this.tableData[2].additional*2;
        // 意志力池 （决心【3】+沉着【6】+决心附加【 】×2）= 9
        this.$store.state.fx4.willpower = this.tableData[5].base + 
        ...
        this.$store.state.fx4.reflection = this.tableData[1].base + 
        ...
        this.$store.state.fx4.investigation = this.tableData[2].base + 
        ...
        this.$store.state.fx4.investigation = this.tableData[4].base + 
        this.$store.state.fx3.tableData[8].base + 
        this.$store.state.fx3.tableData[8].data[i].level;
          }else{
        this.$store.state.fx4.investigation = this.tableData[4].base + this.

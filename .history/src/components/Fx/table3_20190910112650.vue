<template>
  <div style="width:90%; margin:0 auto">
        ...
        >
          ...
          <el-table-column prop="sel" label="专业" align="center">
            <template slot-scope="scope">
              ...
              <el-button type="primary" plain style="cursor: pointer;" @click="Dialog = true; this.$data.index = scope.$index" >编辑</el-button>
              {{scope.row.sel}}
            </template>
          </el-table-column>
        </el-table>
    ...
    数据:{{tableData}}
        ...
        <el-dialog  :visible.sync="Dialog" center width="89%">
      <!-- <el-row>
  ...
  watch: {
    ruleForm: {
      handler: function(event) {
        this.$store.commit("setTable3", this.tableData);
      },
      deep: true
    }
  },

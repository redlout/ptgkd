        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="12" :lg="8">
            <el-form-item label="美德" prop="virtue_id">
              ...
              <!-- <el-input :disabled="true" v-model="ruleForm.virtue_name" style="width: 65%;"></el-input> -->
               <el-button type="primary" plain disabled v-model="ruleForm.virtue_name" style="width: 65%;">{{ruleForm.virtue_name}}</el-button>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>

    ...
    <el-dialog title="美德" :visible.sync="virtueDialog" width="30%" center>
      <el-form ref="virtueForm" :model="virtueForm">
        <el-row>
          <el-col :xs="12" :sm="12" :lg="8">
            <el-card shadow="hover" style="background-color: rgb(240, 242, 245);">
              <el-form-item prop="virtue-lawful-good">
                <el-input type="button" v-model="input"  style="width: 40%;">守序善良</el-input>
              </el-form-item>
            </el-card>
          </el-col>
          <el-col :xs="12" :sm="12" :lg="8">
            <el-card shadow="hover" style="background-color: rgb(240, 242, 245);"></el-card>
          </el-col>
          <el-col :xs="12" :sm="12" :lg="8">
            <el-card shadow="hover" style="background-color: rgb(240, 242, 245);"></el-card>
          </el-col>

<template>
  ...
  >
        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="12" :lg="8">
            ...
            <el-form-item label="美德" prop="virtue">
              ...
              <!-- <el-button style="width:40%;">选择</el-button> -->
              <el-input v-model="input" :disabled="true" style="width: 40%;"></el-input>
            </el-form-item>
            <!-- </el-card> -->
          </el-col>
        </el-row>
    ...
    <el-dialog title="美德" :visible.sync="virtueDialog"  center style="padding:0;">
      <el-form ref="virtueForm" :model="virtueForm">
        <el-row >
          <el-col :xs="12" :sm="12" :lg="8" v-for="(virtue) of virtue_good_List" :key="virtue.id">
            <el-card shadow="hover" style="background-color: rgb(240, 242, 245); weight:150px; height:" v-on:clic="clickVirtue(virtue.id)">
              <img :src="virtue.imgsrc" />
            </el-card>
          </el-col>
        </el-row>
               <el-row >
          <el-col :xs="12" :sm="12" :lg="8" v-for="(virtue) of virtue_neutral_List" :key="virtue.id">
            <el-card shadow="hover" style="background-color: rgb(240, 242, 245);" v-on:clic="clickVirtue(virtue.id)">
              <img :src="virtue.imgsrc" />
            </el-card>
          </el-col>
        </el-row>

<template>
  ...
  >
    <div class="main-container">
      ...
      >
        <el-row>
                    <el-col :lg="8" :xs="12" :sm="12" :offset="16">
            <el-card shadow="hover" style="background-color: rgb(240, 242, 245);">点我可以上传立绘</el-card>
          </el-col>
          <el-col :lg="16">
            <el-row>
        ...
        <el-row>
          <el-col :xs="12" :sm="12" :lg="8">
            ...
            <el-form-item label="美德" prop="virtue">
              ...
              <el-input v-model="input" :disabled="true" style="width:20px;"></el-input>
            </el-form-item>
            <!-- </el-card> -->
          </el-col>
          <el-col :xs="12" :sm="12" :lg="8">

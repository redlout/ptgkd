  ...
  methods:{
    clickVirtue(id,name){
      ...
      if(this.$data.ruleForm.virtue_id == id){
        this.$data.ruleForm.virtue_id = !this.$data.ruleForm.virtue_id;
        this.$data.ruleForm.virtue_name = !this.$data.ruleForm.virtue_name;
              console.log("ssssssssssssssssss",id,name)
      }else{

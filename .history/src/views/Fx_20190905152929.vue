        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="12" :lg="8">
            ...
            <el-form-item label="美德" prop="virtue">
              <el-button v-model="ruleForm.virtue" @click="virtueDialog=true">选择</el-button>
              <!-- <el-button style="width:40%;">选择</el-button> -->
              <el-input :disabled="true" v-model="ruleForm.virtue" style="width: 40%;"></el-input>
            </el-form-item>
            <!-- </el-card> -->
          </el-col>
        </el-row>
    ...
    <el-dialog title="美德" :visible.sync="virtueDialog" center>
        <el-row>
          <el-col :xs="12" :sm="12" :lg="8" v-for="(virtue) of virtue_good_List" :key="virtue.id">
            ...
            > -->
              <img :src="virtue.imgsrc" v-on:click="clickVirtue(virtue.id)" />
            <!-- </el-card> -->
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="12" :sm="12" :lg="8" v-for="(virtue) of virtue_neutral_List" :key="virtue.id">
            <el-card
              shadow="hover"
              style="background-color: rgb(240, 242, 245);"
              v-on:click="clickVirtue(virtue.id)"
            >
...
export default {
  ...
  methods:{
    clickVirtue(id){
      console.log(id)
      if(ruleForm.virtue == id){
        this.$data.ruleForm.virtue = !ruleForm.virtue;
      }else{
        ruleForm.virtue = id;
      }
    }

        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="12" :lg="8">
            ...
            <el-form-item label="美德" prop="virtue_id">
              ...
              <el-input :disabled="true" v-model="ruleForm.virtue_name" style="width: 40%;"></el-input>
            </el-form-item>
            <!-- </el-card> -->
          </el-col>
        </el-row>
    ...
    <el-dialog title="美德" :visible.sync="virtueDialog" center>
        <el-row>
          <el-col :xs="12" :sm="12" :lg="8" v-for="(virtue) of virtue_good_List" :key="virtue.id">
            ...
            > -->
              <img :src="virtue.imgsrc" v-on:click="clickVirtue(virtue.id, virtue.name)" />
            <!-- </el-card> -->
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  methods:{
    clickVirtue(id,name){
      console.log(id,name)
      if(ruleForm.virtue_id == id){
        this.$data.ruleForm.virtue_id = !ruleForm.virtue_id;
        this.$data.ruleForm.virtue_anme = !ruleForm.virtue_name;
      }else{
        this.$data.ruleForm.virtue_id = id;
        this.$data.ruleForm.virtue_anme = name;
      }
    }
  }
};
